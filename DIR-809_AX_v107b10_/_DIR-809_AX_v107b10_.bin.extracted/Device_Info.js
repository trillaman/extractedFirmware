		...
		function wireless_selector()
		{
			...
			if (WLAN_ENABLED != "1") {
				...
				if (wlan_mac_addr.toUpperCase() == "00:00:00:00:00:00") {
					...
					document.getElementById("ssid").innerHTML = str2html("<%getInfo("ssid");%>");
...
/*			if( lang =="0"){
			xsltProcessor = new xsltProcessingObject(xsltReady, xsltProcessorTimeout, 6000, "./Status/lan_computers_table.sxsl");
		}else{
			xsltProcessor = new xsltProcessingObject(xsltReady, xsltProcessorTimeout, 6000, "./Status/lan_computers_table.sxsl");
		}*/
		...
		xsltProcessor = new xsltProcessingObject(xsltReady, xsltProcessorTimeout, 6000, "./Status/lan_computers_table_sc.sxsl");
	}else if(LangCode == "TW"){
		xsltProcessor = new xsltProcessingObject(xsltReady, xsltProcessorTimeout, 6000, "./Status/lan_computers_table_tw.sxsl");
	}else{
		xsltProcessor = new xsltProcessingObject(xsltReady, xsltProcessorTimeout, 6000, "./Status/lan_computers_table.sxsl");
	}
			...
			if(LangCode == "EN"){
				...
				igmpXsltProcessor = new xsltProcessingObject(igmpXsltReady, igmpXsltProcessorTimeout, 6000, "../igmp_group_memberships_sc.sxsl");
			}else if(LangCode == "TW"){
				igmpXsltProcessor = new xsltProcessingObject(igmpXsltReady, igmpXsltProcessorTimeout, 6000, "../igmp_group_memberships_tw.sxsl");
			}else{
				igmpXsltProcessor = new xsltProcessingObject(igmpXsltReady, igmpXsltProcessorTimeout, 6000, "../igmp_group_memberships.sxsl");
			}
			...
			connection_status_retriever = new xmlDataObject(connection_status_ready, connection_status_timeout, 10000, "./Status/wan_connection_status.asp");
		...
		{
			document.write("<form id=\"mainform\" name=\"mainform\" action=\"/goform/formSetWanStatus\" method=\"post\" enctype=\"application/x-www-form-urlencoded\">");
			document.write("<div class=\"section\"><div class=\"section_head\"> ");
			document.write("<h2><SCRIPT >ddw(\"txtDeviceInfoFull\");</SCRIPT></h2>");
			document.write("<p><SCRIPT >ddw(\"txtAlldisplayedhere\");</SCRIPT></p><br>");
			document.write("<fieldset><p><label class=\"duple_Dev_info\"><strong><SCRIPT>ddw(\"txtFirmwareVersion\");</SCRIPT>&nbsp;:</strong></label>");
			document.write("<strong id=\"firmware_version\" class=\"output\"><span id=\"fw_minor_current\"></span>,&nbsp;&nbsp;<%getInfo(\"fwBuiltDate\")%></strong></p></fieldset>");
			document.write("</div><div class=\"box\"style=\"display:none\"><h3><SCRIPT >ddw(\"txtGeneral\");</SCRIPT></h3><p class=\"box_msg\">	</p><fieldset><p><label class=\"duple_Dev_info\">");
			document.write("<SCRIPT >ddw(\"txtTime\");</SCRIPT>&nbsp;:</label><span id=\"current_time\" class=\"output\">&nbsp;</span></p><p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtFirmwareVersion\");</SCRIPT>&nbsp;:</label><strong id=\"firmware_version\" class=\"output\"><span id=\"fw_minor_current\"></span>,&nbsp;&nbsp;<%getInfo(\"fwBuiltDate\")%></strong></p></fieldset></div>");
			document.write("<div class=\"box\"><h3>LAN</h3><fieldset><p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtMACAddress\");</SCRIPT>&nbsp;:</label>");
			document.write("<span id=\"lan_mac_addr\" class=\"output\"><% getInfo(\"lanMacAddr\"); %>&nbsp;</span></p><p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtIPAddress\");</SCRIPT>&nbsp;:</label>");
			document.write("<span id=\"lan_ip_address\" class=\"output\"><% getInfo(\"ip\"); %></span></p><p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtSubnetMask2\");</SCRIPT>&nbsp;:</label>");
			document.write("<span id=\"lan_subnet\" class=\"output\"><% getInfo(\"mask\"); %></span></p><div id=\"bridge_mode_only_lan_settings\"><p><label class=\"duple_Dev_info\">");
			document.write("<SCRIPT >ddw(\"txtDefaultGateway2\");</SCRIPT>&nbsp;:</label><span id=\"lan_gateway\" class=\"output\"><% getInfo(\"gateway-rom\");%></span></p>	<p>");
			document.write("<label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtPrimaryDNSServer\");</SCRIPT>&nbsp;:</label><span id=\"lan_primary_dns\" class=\"output\"><% getInfo(\"wan-dns1\");%></span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtSecondaryDNSServer\");</SCRIPT>&nbsp;:</label><span id=\"lan_secondary_dns\" class=\"output\"><% getInfo(\"wan-dns2\");%></span></p></div>");
			document.write("<div id=\"router_mode_only_lan_settings\"><p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtDHCPServer\");</SCRIPT>&nbsp;:</label>");			
			document.write("<span id=\"info_dhcp_server_status\" class=\"output\"><% getInfo(\"dhcp_server\");%>&nbsp;</span></p></div></fieldset></div>");
			document.write("<div class=\"box\"  id=\"display_wan_box\"><h3>Internet</h3><table cellpadding=\"1\" cellspacing=\"1\" border=\"0\" width=\"525\">");
			document.write("<tr><td class=\"r_tb\" width=\"258\"><SCRIPT>ddw(\"txtMACAddress\");</SCRIPT>&nbsp;:</td><td class=\"l_tb\" width=\"267\"><div id=\"display_wanmacaddr\">&nbsp;</div></td>");
			document.write("</tr><tr><td class=\"r_tb\"><SCRIPT>ddw(\"txtConnection\");</SCRIPT>&nbsp;:</td><td class=\"l_tb\">");
			document.write("<input class=\"l_tb\" type=\"text\" size=40 readOnly id=\"connstate\" value=\"\" style=\"BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px\" ><%getInfo(\"wan_Type_check\")%>");
			document.write("<input type=button onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?connect=true');\" name=bt_connect id=bt_connect value=\"\">&nbsp;");
			document.write("<input type=button onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?connect=false');\" name=bt_disconnect id=bt_disconnect value=\"\">");
			document.write("</td></tr><tr><td class=\"r_tb\"><SCRIPT >ddw(\"txtIPAddress\");</SCRIPT>&nbsp;:</td><td class=\"l_tb\"><div id=\"display_wanipaddr\">&nbsp;</div></td>");			
			document.write("</tr><tr><td class=\"r_tb\"><SCRIPT >ddw(\"txtSubnetMask2\");</SCRIPT>&nbsp;:</td><td class=\"l_tb\"><div id=\"display_wansubnet\">&nbsp;</div></td>");
			document.write("</tr><tr><td class=\"r_tb\"><SCRIPT >ddw(\"txtDefaultGateway2\");</SCRIPT>&nbsp;:</td><td class=\"l_tb\"><div id=\"display_wangateway\">&nbsp;</div></td>");
			document.write("</tr><tr><td class=\"r_tb\"><SCRIPT >ddw(\"txtDNS\");</SCRIPT>&nbsp;:</td><td class=\"l_tb\"><div id=\"display_wandns\">&nbsp;</div></td></tr></table></div>");
			document.write("<div class=\"box\" id=\"wan_box\" style=\"display:none\"><h3><SCRIPT >ddw(\"txtInternet\");</SCRIPT></h3><fieldset>");
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtConnectionType\");</SCRIPT>&nbsp;:</label><span id=\"wan_ip_mode\" class=\"output\">&nbsp;</span></p>");
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtQoSEngine\");</SCRIPT>:</label><span id=\"wan_qos_engine\" class=\"output\"><SCRIPT >ddw(\"txtActive\");</SCRIPT></span></p>");
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtCableStatus\");</SCRIPT>&nbsp;:</label><span id=\"wan_physical_state\" class=\"output\">&nbsp;</span></p>");
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtNetworkStatus\");</SCRIPT>&nbsp;:</label><span id=\"wan_network_status\" class=\"output\">&nbsp;</span></p>");			
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtConnectionUpTime\");</SCRIPT>&nbsp;:	</label><span id=\"wan_interface_up_time_str\" class=\"output\">&nbsp;</span></p>");
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtMACAddress\");</SCRIPT>&nbsp;:</label><span id=\"wan_mac_addr\" class=\"output\">&nbsp;</span></p>");
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtConnectionType\");</SCRIPT>&nbsp;:</label>");
			document.write("<input id=\"wan_dhcp_button1\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?renew=true');\" style=\"display:none\" />");
			document.write("<input id=\"wan_dhcp_button2\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?renew=false');\" style=\"display:none\" />");
			document.write("<input id=\"wan_pppoe_button1\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?connect=true');\" style=\"display:none\" />");
			document.write("<input id=\"wan_pppoe_button2\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?connect=false');\" style=\"display:none\" />");
			document.write("<input id=\"wan_pptp_button1\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?connect=true');\" style=\"display:none\" />");			
			document.write("<input id=\"wan_pptp_button2\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?connect=false');\" style=\"display:none\" />");
			document.write("<input id=\"wan_l2tp_button1\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?connect=true');\" style=\"display:none\" />");
			document.write("<input id=\"wan_l2tp_button2\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?connect=false');\" style=\"display:none\" />");
			document.write("<input id=\"wan_bigpond_button1\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?login=true');\" style=\"display:none\" />");
			document.write("<input id=\"wan_bigpond_button2\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/Status/wan_button_action.asp?login=false');\" style=\"display:none\" /></p>");
			document.write("<div id=\"box_authsecmodel_status\" style=\"display:none\">");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtAuthentication\");</SCRIPT>&amp;<SCRIPT >ddw(\"txtSecurity\");</SCRIPT>&nbsp;:</label><span id=\"wan_auth_sec_model\" class=\"output\">&nbsp;</span></p></div>");
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtIPAddress\");</SCRIPT>&nbsp;:</label><span id=\"wan_ip_address\" class=\"output\">&nbsp;</span></p>");			
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtSubnetMask2\");</SCRIPT>&nbsp;:</label><span id=\"wan_subnet\" class=\"output\">&nbsp;</span></p>");
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtDefaultGateway2\");</SCRIPT>&nbsp;:</label>");
			document.write("<span id=\"wan_gateway\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtPrimaryDNSServer\");</SCRIPT>&nbsp;:</label><span id=\"wan_primary_dns\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtSecondaryDNSServer\");</SCRIPT>&nbsp;:</label><span id=\"wan_secondary_dns\" class=\"output\">&nbsp;</span></p>");
			document.write("<div id=\"box_bigpond_status\" style=\"display:none\"><p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtBigPondServerName\");</SCRIPT>&nbsp;:</label><span id=\"bigpond_server\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtBigPondStatus\");</SCRIPT>&nbsp;:</label><span id=\"bigpond_currstatus\" class=\"output\">&nbsp;</span></p></div></fieldset></div>");
			document.write("<div class=\"box\" id=\"wan_mpppoe_primary_button\" style=\"display:none\"><h3>WAN</h3><p class=\"box_msg\"></p><fieldset>");			
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtConnectionType\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_primary\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtCableStatus\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_primary_physical_state\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\">	<SCRIPT >ddw(\"txtNetworkStatus\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_primary_network_status\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtConnectionUpTime\");</SCRIPT>&nbsp;:</label><span id=\"wan_primary_interface_up_time_str\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\">&nbsp;</label><input id=\"wan_mpppoe_primary_button1\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/wan_pppoe.cgi?connect=true');\" style=\"display:none\" />");
			document.write("<input id=\"wan_mpppoe_primary_button2\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/wan_pppoe.cgi?connect=false');\" style=\"display:none\" /></p>");
			document.write("<div id=\"mpppoe_primary_box_authsecmodel_status\" style=\"display:none\">");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtAuthentication\");</SCRIPT>&amp;<SCRIPT >ddw(\"txtSecurity\");</SCRIPT>&nbsp;:</label>");			
			document.write("<span id=\"wan_mpppoe_primary_auth_sec_model\" class=\"output\">&nbsp;</span></p></div>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtIPAddress\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_primary_ip_address\" class=\"output\">&nbsp;</span></p>");
			document.write("<p>	<label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtSubnetMask2\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_primary_subnet\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtDefaultGateway2\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_primary_gateway\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtPrimaryDNSServer\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_primary_primary_dns\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtSecondaryDNSServer\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_primary_secondary_dns\" class=\"output\">&nbsp;</span></p></fieldset></div>");
			document.write("<div class=\"box\" id=\"wan_mpppoe_secondary_button\" style=\"display:none\"><h3>WAN</h3><p class=\"box_msg\"></p><fieldset><p>");
			document.write("<label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtConnectionType\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_secondary\" class=\"output\">&nbsp;</span></p>");			
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtCableStatus\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_secondary_physical_state\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtNetworkStatus\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_secondary_network_status\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtConnectionUpTime\");</SCRIPT>&nbsp;:</label><span id=\"wan_secondary_interface_up_time_str\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\">&nbsp;</label>");
			document.write("<input id=\"wan_mpppoe_secondary_button1\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/sec_pppoe.cgi?connect=true');\" style=\"display:none\" />");
			document.write("<input id=\"wan_mpppoe_secondary_button2\" type=\"button\" value=\"\" onclick=\"wan_button_action('http://<% getInfo(\"goformIpAddr\"); %>/sec_pppoe.cgi?connect=false');\" style=\"display:none\" /></p>");
			document.write("<div id=\"mpppoe_secondary_box_authsecmodel_status\" style=\"display:none\">");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtAuthentication\");</SCRIPT>&amp;<SCRIPT >ddw(\"txtSecurity\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_secondary_auth_sec_model\" class=\"output\">&nbsp;</span></p></div>");			
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtIPAddress\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_secondary_ip_address\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtSubnetMask2\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_secondary_subnet\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtDefaultGateway2\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_secondary_gateway\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtPrimaryDNSServer\");</SCRIPT>&nbsp;:	</label><span id=\"wan_mpppoe_secondary_primary_dns\" class=\"output\">&nbsp;</span></p>");
			document.write("<p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtSecondaryDNSServer\");</SCRIPT>&nbsp;:</label><span id=\"wan_mpppoe_secondary_secondary_dns\" class=\"output\">&nbsp;</span></p></fieldset></div>");
			document.write("<div class=\"box\"><h3><SCRIPT >ddw(\"txtWirelessLAN\");</SCRIPT></h3><fieldset><p style=\"display:none\">");
			document.write("<label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtWirelessRadio\");</SCRIPT>&nbsp;:</label><span class=\"output\" id=\"wireless_radio\"><%getIndexInfo(\"wlanDisabled\");%>&nbsp;</span></p>");
			document.write("<div id=\"wirless_status\"><p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtWirelessMode\");</SCRIPT>&nbsp;:</label><span class=\"output\" id=\"wlan_mode\"></span></p>");			
			document.write("<p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtMACAddress\");</SCRIPT>&nbsp;:</label><span class=\"output\" id=\"wlan_mac_addr\"></span></p><p><label class=\"duple_Dev_info\">SSID&nbsp;:</label>");
			document.write("<span class=\"output\" id=\"ssid\"></span>	</p><p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtChannel\");</SCRIPT>&nbsp;:</label>");
			document.write("<span class=\"output\" id=\"wlan_channel\"><% getInfo(\"channel_drv\");%>&nbsp;</span></p><p><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtEncryption\");</SCRIPT>&nbsp;:</label>");
			document.write("<span class=\"output\" id=\"security_type\">&nbsp;</span></p><p style=\"display:none\"><label class=\"duple_Dev_info\"><SCRIPT >ddw(\"txtWiFiProtectedSetup\");</SCRIPT>&nbsp;:</label>");
			document.write("<span class=\"output\" id=\"wifisc_configured\">&nbsp;</span></p></div></fieldset></div><div class=\"box\" id=\"lan_computers_box\" style=\"display:none\">");
			document.write("<h3><SCRIPT >ddw(\"txtLANComputers\");</SCRIPT></h3><p class=\"box_msg\"></p><div id=\"lan_computers_container\"></div></div><div class=\"box\" id=\"multicast_memberships_div\" style=\"display:none\">");
			document.write("<h3><SCRIPT >ddw(\"txtIGMPMulticastmember\");</SCRIPT></h3><p class=\"box_msg\"/><div id=\"igmp_membership_container\"></div></div></div></form>");
