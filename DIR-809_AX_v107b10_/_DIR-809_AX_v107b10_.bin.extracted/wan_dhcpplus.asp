...
/*user name and password*/
	...
	if(strchk_unicode(mf.wan_dhcpplus_username.value) == true)//kity
	{
		alert(sw("txtInvalidUsername"));
		mf.wan_dhcpplus_username.focus();
		return false;
	}	
	if(strchk_unicode(mf.wan_dhcpplus_password.value) == true)//kity
	{
...
var auth = hex_hmac_md5(PrivateKey, current_time.toString()+"/Basic/wan_dhcpplus.asp");
