...
function xmlDataObject_createXMLDocument()
{
	...
	try{
		this.xmlDoc = new ActiveXObject("MSXML2.FreeThreadedDOMDocument.5.0");
	}catch(e7){
		try {
					...
					try {
						...
						try {
							...
							try{
								...
								if (this.xmlDoc.overrideMimeType) {/*set MiME */
...
function xsltProcessingObject(dataReadyFunc, dataTimeoutFunc, timeoutMillis, dataURL)
{
	...
	var copy = this; 
	var try_XSLTProcessor = null;
    try{
        try_XSLTProcessor = new XSLTProcessor();
    }catch(e){}
	this.platformMoz = (document.implementation && document.implementation.createDocument && try_XSLTProcessor!= null);
...
{
	try{
		return new ActiveXObject("MSXML2.XSLTemplate.5.0");
	}catch(e){}
	try {
...
function xslt_createEmptyDocument()
{
	 ...
	 */
	 try{
		return ActiveXObject("MSXML2.FreeThreadedDOMDocument.5.0");
	}catch(e7){}
	try {
