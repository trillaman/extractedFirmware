...
function GoToDlink()
{
	...
	{
		self.location.href = "http://www.dlinktw.com.tw";
	}
	else
	{
...
RenderWarnings();	
get_by_id("smartok").value = sw("txtWizardEasyStepConfig1");	
}
//]]>
</script>
</head>
...
<div class="simple2body">
	...
	<h2><SCRIPT>ddw("txtEasySetupIsCompleted");</SCRIPT></h2>
		<div class="gap"></div>
		<div class="gap"></div>
		<div class="gap"></div>
		<div class="gap"></div>
		<p style="font-size:14px;font-weight: bold;text-align:left;width:240px;"><SCRIPT >ddw("txtEasyInternetOk");</SCRIPT></p>
		<div class="gap"></div>
		<div class="gap"></div>
	</div><!-- networkmap -->
	<div class="gap"></div>
	...
	<div class="centerline">
		<input type="button" id="smartok" value="" onClick="GoToDlink()"; class="button_submit" style="background:url(../Images/button_n.jpg); border-style:none; width:187px; height:48px;"/>
	</div>	
</div><!-- simple2body -->
