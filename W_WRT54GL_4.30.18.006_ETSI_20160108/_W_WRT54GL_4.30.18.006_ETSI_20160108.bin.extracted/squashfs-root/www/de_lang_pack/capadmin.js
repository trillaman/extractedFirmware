...
adtopmenu.upgarde="Firmware aktualisieren";
//adtopmenu.lang="Language";*
adtopmenu.lang="Language";

var adleftmenu = new Object();
adleftmenu.routerpsw="Router-Passwort";
adleftmenu.localaccess="Lokaler Routerzugriff";
//adleftmenu.routerpsw="Router-Passwort";
adleftmenu.remoteaccess="Entfernter Routerzugriff";
...
mgt.upnp="UPnP";
mgt.igmp="IGMP";
mgt.upnpconfig="Allen Benutzern<BR>&nbsp;Konfiguration gestatten";
mgt.upnpinternetdis="Benutzern gestatten, <BR>&nbsp;Internetzugriff zu<BR>&nbsp;deaktivieren";

var log = new Object();
log.inlogtbl="Tabelle fur eingehende Protokolle";
log.srcip="IP-Adresse der Quelle";
log.desportnum="Ziel-Port-Nummer";
log.outlogtbl="Tabelle fur ausgehende Protokolle";
...
ping.times="Anzahl der durchzuführenden Pings";
...
fwupgrade.warning="<B>Warnung: </B>Der Aktualisierungsvorgang kann einige Minuten in Anspruch nehmen. Schalten Sie Ihren Computer nicht aus, und drücken Sie nicht die Reset-Taste.";
