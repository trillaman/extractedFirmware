...
<TR>
	  ...
	  <TD width=15 background=image/UI_05.gif height=25>&nbsp;</TD></TR>
        <TR>
          ...
          <TD width=8 background=image/UI_04.gif height=25>&nbsp;</TD>
          <TD colSpan=3 height=25>&nbsp;</TD>
          <TD width=101 height=25>&nbsp;<script>Capture(hindex2.hbs)</script>:&nbsp;</TD>
	  <TD width=296 height=25><INPUT maxLength=63 size=24 name="hb_server_ip" value='<% nvram_get("hb_server_ip"); %>' onBlur=valid_hb(this,"Heartbeat%20Server")></TD>
	  <TD height=25>&nbsp;</TD>
	  <TD width=15 background=image/UI_05.gif height=25>&nbsp;</TD></TR>
	<TR>
	  <TD width=156 bgColor=#e7e7e7 colSpan=3 height=25></TD>
