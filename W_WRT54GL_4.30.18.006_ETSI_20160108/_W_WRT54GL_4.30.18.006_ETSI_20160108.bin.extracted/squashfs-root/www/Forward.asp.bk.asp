...
<TABLE cellSpacing=0 cellPadding=0 width=809 border=0>
  <TBODY>
  <TR>
<TD class=LOGO_TD><IMG src="image/linksys_logo.png" class=LOGO></TD>
...
-->
              ...
              <TR>
                <TD align=middle bgColor=#000000 height=20><FONT 
                  ...
                  href="index.asp?session_id=<% nvram_get("session_key"); %>"><script>Capture(bmenu.setup)</script></a></FONT></TD>
                <TD align=middle bgColor=#000000 height=20><FONT 
                  style="FONT-WEIGHT: 700" color=#ffffff>
                <a style="TEXT-DECORATION: none" href="Wireless_Basic.asp?session_id=<% nvram_get("session_key"); %>"><script>Capture(bmenu.wireless)</script></a></FONT></TD>
                <TD align=middle bgColor=#000000 height=20><FONT 
                  style="FONT-WEIGHT: 700" color=#ffffff>
                <a style="TEXT-DECORATION: none" href="Firewall.asp?session_id=<% nvram_get("session_key"); %>"><script>Capture(bmenu.security)</script></a></FONT></TD>
                <TD align=middle bgColor=#000000 height=20><FONT 
                  style="FONT-WEIGHT: 700" color=#ffffff>
                <a style="TEXT-DECORATION: none" href="Filters.asp?session_id=<% nvram_get("session_key"); %>"><script>Capture(bmenu.accrestriction)</script></a></FONT></TD>
                ...
                <TD align=middle bgColor=#000000 height=20>
                  <P style="MARGIN-BOTTOM: 4px"><FONT style="FONT-WEIGHT: 700" 
                  color=#ffffff>
                  <a style="TEXT-DECORATION: none" href="Management.asp?session_id=<% nvram_get("session_key"); %>"><script>Capture(bmenu.admin)</script></a>&nbsp;&nbsp;&nbsp;&nbsp;</FONT></P></TD>
                <TD align=middle bgColor=#000000 height=20>
                  <P style="MARGIN-BOTTOM: 4px"><FONT style="FONT-WEIGHT: 700" 
                  color=#ffffff>
                  <a style="TEXT-DECORATION: none" href="Status_Router.asp?session_id=<% nvram_get("session_key"); %>"><script>Capture(bmenu.statu)</script></a>&nbsp;&nbsp;&nbsp;&nbsp;</FONT></P></TD>
              </TR>
              <TR>
...
<% support_invmatch("PORT_TRIGGER_SUPPORT", "1", "<!--"); %>
                      ...
                      <A href="Triggering.asp?session_id=<% nvram_get("session_key"); %>"><script>Capture(trigger2.ptrigger)</script></A></TD>
<% support_invmatch("PORT_TRIGGER_SUPPORT", "1", "-->"); %>
<% support_invmatch("UPNP_FORWARD_SUPPORT", "1", "<!--"); %>
                      ...
                      <A href="Forward_UPnP.asp?session_id=<% nvram_get("session_key"); %>">UPnP Forward</A></TD>
<% support_invmatch("UPNP_FORWARD_SUPPORT", "1", "-->"); %>
                      <TD width=1><P class=bar><font color='white'><b>|</b></font></P></TD>
                      ...
                      <a href="DMZ.asp?session_id=<% nvram_get("session_key"); %>"><script>Capture(share.dmz)</script></a></TD>
<% support_invmatch("HW_QOS_SUPPORT", "1", "<!--"); %>
                      ...
                      <a href="QoS.asp?session_id=<% nvram_get("session_key"); %>"><script>Capture(trigger2.qos)</script></a></TD>
<% support_invmatch("HW_QOS_SUPPORT", "1", "-->"); %>
...
<b><a target="_blank" href="help/HForward.asp?session_id=<% nvram_get("session_key"); %>"><script>Capture(share.more)</script></a></b>
</span></font></TD>
...
<script>document.write("<input type=button name=cancel" + " value=\"" + sbutton.cancel + "\" onClick=window.location.replace(\"Forward.asp?session_id=<% nvram_get("session_key"); %>\")>");</script>
