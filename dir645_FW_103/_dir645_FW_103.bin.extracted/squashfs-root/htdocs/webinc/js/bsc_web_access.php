...
{
	<?
		if(isfile("/etc/services/UPNPC.php")==1) echo 'services: "WEBACCESS,INET.LAN-1,UPNPC",';
		else echo 'services: "WEBACCESS,INET.LAN-1",';
	?>
	OnLoad: function() {},
	OnUnload: function() {}, 
	...
	{
		if (!TEMP_IsDigit(OBJ("webaccess_httpport").value))
		{
			BODY.ShowAlert("<?echo i18n("The HTTP Access Port number is not valid.");?>");
			return false;
		}
		if (!TEMP_IsDigit(OBJ("webaccess_httpsport").value))
		{
