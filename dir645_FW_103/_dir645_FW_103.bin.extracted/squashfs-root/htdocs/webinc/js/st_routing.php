    ...
    Page.prototype =
    {
    	...
    	InitValue: function(xml)
      {
    		PXML.doc = xml;
    		var self = this;
    		this.CallAjax("echo ==ROUTEN==;route -n;echo ==END1==;echo ==DEFAULT==;ip route show table default;echo ==END2==;echo ==STATIC==;ip route list table STATIC;echo ==END3==;");
    		return true;
    	},
    	CallAjax: function(cmd)
    	{
    		...
    		ajaxObj.sendRequest("command.php", "cmd="+cmd);    
    	},
    	PreSubmit: function()
    	{
    		return null;
