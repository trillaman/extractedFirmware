...
Page.prototype =
{
	...
	*********************************************************/
	...
	{				
		...
		/* Reset wizard flag in IPv6 AutoDetection Mode, by Jerry Kao. */
		//var wan5auto = PXML.FindModule("INET.WAN-5");
		//XA(wan5auto+"/runtime/services/wandetect6/wizard", "1");
		//alert("Jerry_wan5auto_0");		
		...
		switch(OBJ("wan_ipv6_mode").value)
		{
			case "STATIC":
				...
				// for Primary and Secondary DNS contains IPv4 addr, by Jerry Kao.		
			...
			case "AUTODETECT":
				/* Set wizard flag in IPv6 AutoDetection Mode, by Jerry Kao. */				
				//XS(wan5auto+"/runtime/services/wandetect6/wizard", "0");
				//alert("Jerry_wan5auto_1");
...
*/
	...
	PrePppoe: function()
	{
		...
		{
			if (COMM_Equal(OBJ("pppoe_sess_share").getAttribute("modified"), true))
			{
           			XS(this.wan1.inetp+"/addrtype", "ipv4");
			}
