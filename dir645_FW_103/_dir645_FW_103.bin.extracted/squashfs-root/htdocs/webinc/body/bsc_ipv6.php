...
<div class="blackbox">
	...
	<div class="textinput">
		...
		<span class="value">
			...
			<option value="LL"><?echo i18n("Local Connectivity Only");?></option>
			</select>
		</span>
	</div>
	<div class="gap"></div>
...
-->
	...
	<div id="box_wan_6rd_body" style="display:none">
		<div class="textinput">
			<span class="name"><?echo i18n("Enable Hub and Spoke Mode");?></span>
			<span class="delimiter">:</span>
			<span class="value"><input id="en_hub_spoke" type="checkbox" onclick="PAGE.OnClick6rdHubSpoke();"/></span>
		</div>
		<div class="textinput">
...
-->
	...
	<div id="box_lan_ul" style="display:none"> 
		<h2><?echo i18n("LAN IPv6 ADDRESS SETTINGS");?></h2>
			<p>
				<?echo i18n("LAN IPv6 address for local IPv6 communications.");?>
			</p>
	</div>
	...
	<div id="box_lan_pd_hint_body" style="display:none">
		<div class="textinput">
			<span class="name"><?echo i18n("Manual IA_PD hint configuration");?></span>
			<span class="delimiter">:</span>
			<span class="value"><input id="en_dhcp_pd_hint" type="checkbox" onclick="PAGE.OnClickpdhint();"/></span>
		</div>
		<div class="textinput">
			<span class="name"><?echo i18n("Specified Prefix");?></span>
			<span class="delimiter">:</span>
			<span class="value">
				<input id="dhcppd_hint_prefix" type="text" size="42" maxlength="45" />	/
				<input id="dhcppd_hint_pfxlen" type="text" size="4" maxlength="3" />
			</span>
		</div>
		<div class="textinput">
			<span class="name"><?echo i18n("Specified Prefer Time");?></span>
			<span class="delimiter">:</span>
			<span class="value"><input id="dhcppd_hint_plft" type="text" size="5" maxlength="3" />
				(<?echo i18n("minutes");?>)</span>
		</div>
		<div class="textinput">
			<span class="name"><?echo i18n("Specified Valid Time");?></span>
			<span class="delimiter">:</span>
			<span class="value"><input id="dhcppd_hint_vlft" type="text" size="5" maxlength="3" />
				(<?echo i18n("minutes");?>)
				(<?echo i18n("optional");?>)</span>
		</div>
	</div>
	...
	<div id="box_lan_ul_body" style="display:none">
		<div class="textinput">
			<span class="name"><?echo i18n("LAN IPv6 Unique Local Address");?></span>
			<span class="delimiter">:</span>
			<span class="value">
				<span id="lan_ul"></span>	
				<span id="lan_ul_pl"></span>
			</span>
		</div>
	</div>
	<div class="gap"></div>
