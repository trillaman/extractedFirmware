...
<div id="stage_wan_detect" style="display:none;">
	...
	<div id="cable_fail" style="display:none;">
		<div class="blackbox"> 
			<h2><?echo i18n("Step 1: Configure your Internet Connection");?></h2>
			<div><p class="strong">
				<?echo i18n("Please plug one end of the included Ethernet cable that came with your router into the port labeled INTERNET on the back of the router. Plug the other end of this cable into the Ethernet port on your modem.");?>
			</p></div>
			<div align="center">
			...
			<div class="centerline">
				...
				<input type="button" value="<?echo i18n("Next");?>" onClick="PAGE.WanDetectAgain();" />&nbsp;&nbsp;
	...
	<div id="wantype_unknown" style="display:none;">
		<div class="blackbox"> 
			<h2><?echo i18n("Step 1: Configure your Internet Connection");?></h2>
			<div><p class="strong">
				<?echo i18n("Routers are unable to detect your Internet connection type.");?>
			</p></div>
			<div class="gap"></div>
			<div class="centerline">
				<input type="button" value="<?echo i18n("Cancel");?>" onClick="PAGE.OnClickCancel();" />&nbsp;&nbsp;
...
<div id="stage_ether_cfg" style="display:none;">
	...
	<div id="DHCP">
		<div class="blackbox">
			...
			<div><p class="strong">
				<?echo i18n("To set up this connection, please make sure that you are connected to the D-Link Router with the PC that was originally connected to your broadband connection. If you are, then click the Clone MAC button to copy your computer's MAC Address to the D-Link Router.");?>
			</p></div>
			<div class="textinput">
...
<div id="stage_wlan_result" class="blackbox" style="display:none;">
	...
	<div class="emptyline"></div>
		<div class="centerline">
			...
			<input type="button" name="b_send" value="<? echo i18n("Save");?>" onClick="BODY.OnSubmit();" />&nbsp;&nbsp; 
			<input type="button" name="b_exit" value="<? echo i18n("Cancel");?>" onClick="PAGE.OnClickCancel();" />&nbsp;&nbsp;
		</div>
	<div class="emptyline"></div>
</div>
...
<div id="check_wan_connect" class="blackbox" style="display:none;">
	...
	<div class="centerline"><p class="strong"><? echo i18n("Your settings are being saved.");?></p></div>
	<div class="centerline"><p class="strong"><? echo i18n("Please wait...");?></p></div>
	<div class="centerline"><p class="strong"><? echo i18n("Checking WAN connectivity.");?></p></div>
</div>
