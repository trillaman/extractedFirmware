...
<div class="blackbox">
	...
	<div class="centerline" align="center">
		<table borderColor=#ffffff cellSpacing=1 cellPadding=1 width=525>
			<tr>
				<td ><div class="duple">Sent :</div></td>
				<td width=340><?=$lan1_tx?></td>
				<td ><div class="duple">Received :</div></td>
				<td width=340><?=$lan1_rx?></td>
			</tr>
			<tr>
				<td ><div class="duple">TX Packets Dropped :</div></td>
				<td width=340><?=$lan1_txdrop?></td>
				<td ><div class="duple">RX Packets Dropped :</div></td>
				<td width=340><?=$lan1_rxdrop?></td>
			</tr>

			<tr>
				<td ><div class="duple">Collisions :</div></td>
				<td width=340><?=$lan1_collision?></td>
				<td ><div class="duple">Errors :</div></td>
