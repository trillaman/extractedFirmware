...
<div class="blackbox">
	...
	<div class="textinput">
		<span class="name"><?echo i18n("Lock WPS-PIN Setup");?></span>
		<span class="delimiter">:</span>
		<span class="value"><input id="lock_wifi_security" type="checkbox" /></span>
	</div>	
	
	<!--If the default PSK password is not blank, the wireless setting would never be unconfigured.-->
	<div class="textinput" <? if(get("", "/runtime/devdata/psk")!="") echo "style='display:none;'"; ?>>
