		...
		<script type="text/javascript">		
			...
			function get_media_list(which_media){		
				...
				var para = "ListCategory?id=" + storage_user.get("id") + "&tok=" + storage_user.get("tok")
						 + "&pageoffset=0&maxcount=0" + "&path=&filter=" + which_media;
			...
			function reset_search_box(){
				get_by_id("search_box").value = "<? echo I18N("h", "Search Movies");?>...";	
				show_media_list(false);	
			}
				...
				<div id="navi">
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="82%" class="text_2Copy"><? echo I18N("h", "Movie");?></td>
							<td width="10%"></td>
						</tr>
					</table>
				</div>
					...
					<table width="100%" height="49" border="0" border-color:transparent;align="left" cellpadding="0" cellspacing="0">
						<tr>
							...
							<th width="880" class="search2" scope="row">							
								<input type="text" id="search_box" name="search_box" class="search2" value="<? echo I18N("h", "Search Movies");?>..." onfocus="clear_search_box()" onkeyup="show_media_list(true)" size="105" />
							</th>
