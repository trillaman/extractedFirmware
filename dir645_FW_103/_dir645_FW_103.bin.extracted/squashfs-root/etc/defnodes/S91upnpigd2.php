...
add("xmldoc",				"WANIPConnection2.xml");
add("xmldoc",				"WANIPv6FirewallControl.xml");
...
set($sub_root, "");	anchor($sub_root);
	set("serviceType",			"urn:schemas-upnp-org:service:WANIPConnection:2");
	set("serviceId",			"urn:upnp-org:serviceId:WANIPConn2");
	set("controlURL",			"/soap.cgi?service=WANIPConn2");
	set("eventSubURL",			"/gena.cgi?service=WANIPConn2");
	set("SCPDURL",				"/WANIPConnection2.xml");
$sub_root = $desc_root."/device/deviceList/device:1/deviceList/device:1/serviceList/service:3";
set($sub_root, "");	anchor($sub_root);
	set("serviceType",			"urn:schemas-upnp-org:service:WANIPv6FirewallControl:1");
	set("serviceId",			"urn:upnp-org:serviceId:WANIPv6Firewall1");
	set("controlURL",			"/soap.cgi?service=WANIPv6Firewall1");
	set("eventSubURL",			"/gena.cgi?service=WANIPv6Firewall1");
	set("SCPDURL",				"/WANIPv6FirewallControl.xml");	
