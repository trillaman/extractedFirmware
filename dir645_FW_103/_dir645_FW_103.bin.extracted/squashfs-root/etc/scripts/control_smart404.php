...
if($ACTION=="INIT_SMART404")
{
	...
	echo '/var/run/fakedns --port=63481 --address=/'.$hostname.'/'.$RouterLANIP.' --address=/'.$hostname.$macstr.'/'.$RouterLANIP.' --address=/'.$hostname.'.local/'.$RouterLANIP.' --address=/#/1.33.203.39\n';
}
