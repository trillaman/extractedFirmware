...
$radioID = get("s","/runtime/hnap/GetWLanRadioSettings/RadioID");
...
?>
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Body><GetWLanRadioSettingsResponse xmlns="http://purenetworks.com/HNAP1/"><GetWLanRadioSettingsResult><?=$result?></GetWLanRadioSettingsResult><Mode><?=$wlanStr?></Mode><Enabled><? echo map($path_phyinf_wlan."/active", "1", "true", "*", "false");?></Enabled><MacAddress><? echo query("/runtime/devdata/lanmac");?></MacAddress><SSID><? echo query($path_wlan_wifi."/ssid");?></SSID><SSIDBroadcast><? echo map($path_wlan_wifi."/ssidhidden", "1", "false", "*", "true");?></SSIDBroadcast><ChannelWidth><?=$bandWidth?></ChannelWidth><Channel><?=$channel?></Channel><SecondaryChannel><?=$secondaryChnl?></SecondaryChannel><QoS><?echo map($path_phyinf_wlan."/media/wmm/enable","0","false","*","true");?></QoS></GetWLanRadioSettingsResponse></soap:Body></soap:Envelope>
