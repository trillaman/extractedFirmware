...
<div id="stage_wan_detect" style="display:none;">
	...
	<div id="cable_fail" style="display:none;">
		<div class="blackbox"> 
			...
			<div class="cable_fail_img" align="center">
				<img src="/pic/cable_connection.jpg">
				<div id="text_router_name" class="style_router_name">
					<?echo I18N("h","D-Link Wi-Fi Router");?>
				</div>
				<div id="text_router_type" class="style_router_type">
					<?echo i18n("Cable/xDSL<br>Broadband Modem");?><br>
				</div>
			</div>
			<div class="gap"></div>
			<div class="centerline">
