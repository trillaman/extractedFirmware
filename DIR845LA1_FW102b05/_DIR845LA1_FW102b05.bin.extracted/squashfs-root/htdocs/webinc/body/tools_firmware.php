...
<div class="blackbox">
	...
	<div class="textinput">
		<span class="name"><?echo i18n("Current Firmware Time");?></span>
		<span class="delimiter">:</span>
		<span class="value" id="fw_build_time"></span>
	</div>
	<div class="textinput">
...
<div class="blackbox" id="div_ckfwver" style="display:none;">
	<h2><?echo i18n("Check Latest Firmware Version");?></h2>
	<div class="textinput">
		<span class="name"><?echo i18n("Latest Firmware Version");?></span>
		<span class="delimiter">:</span>
		<span class="value" id=latest_fw_ver></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("Latest Firmware Date");?></span>
		<span class="delimiter">:</span>
		<span class="value" id=latest_fw_date></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("Available Download Site");?></span>
		<span class="delimiter">:</span>
		<span class="value"><select id=fw_dl_locs size=1></select></span>
	</div>
	<div class="textinput">
		<span class="name"></span>
		<span class="delimiter"></span>
		<span class="value"> <input type="button" value='<?echo i18n("Download");?>' onclick="PAGE.OnClickDownloadFW();" /> </span>
	</div>
	<br>
</div>
