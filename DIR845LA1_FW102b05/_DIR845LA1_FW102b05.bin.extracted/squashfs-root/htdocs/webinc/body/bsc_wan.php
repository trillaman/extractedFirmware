	...
	<div class="textinput">
		...
		<span class="value">
			<select id="wan_ip_mode" onchange="PAGE.OnChangeWanIpMode();">
				...
				<?if ($FEATURE_NORUSSIAL2TP!="1")	echo '<option value="r_l2tp">'	.i18n("Russia L2TP (Dual Access)").'</option>\n';?>				
...
<div class="blackbox" id="ipv4_setting">
	...
	<div id="box_wan_dhcp_body" style="display:none">
		<div class="textinput">
			...
			<span class="delimiter">:</span>
			<span class="value"><input id="dhcp_host_name" type="text" size="20" maxlength="15" /></span>
		</div>
		...
		<div class="textinput">
			...
			<span class="delimiter">:</span>
			<span class="value"><input type="checkbox" id="dhcpc_unicast" />&nbsp;&nbsp;<?echo i18n("(compatibility for some DHCP Servers)");?></span>
		</div>
...
<div class="blackbox" id="ppp4_setting">
	...
	<div id="box_wan_ru_l2tp" style="display:none">
	    <h2><?echo i18n("Russia L2TP (Dual Access)");?> :</h2>
	    <p class="strong"> <?echo i18n("Enter the information provided by your Internet Service Provider (ISP).");?> </p>
	</div>	
	<!-- end of header -->
	<!-- pppoe -->
...
if ($FEATURE_NOSCH=="1")	echo '</span>\n';
	...
	<div id="box_wan_pptp_body" style="display:none">
		...
		<div class="textinput">
			...
			<span class="delimiter">:</span>
			<span class="value"><input id="pptp_server" type="text" size="20" maxlength="30" /></span>
		</div>
		<div class="textinput">
			<span class="name"><?echo i18n("Username");?></span>
			<span class="delimiter">:</span>
