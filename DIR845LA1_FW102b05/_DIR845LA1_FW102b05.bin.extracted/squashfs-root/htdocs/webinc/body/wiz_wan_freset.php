...
<div id="stage_desc" class="blackbox" style="display:none;">
	...
	<div>
		<ul>
			...
			<li><?echo i18n("Step 3").": ".i18n("Set Advanced DNS Services");?></li>
			<li><?echo i18n("Step 4").": ".i18n("Configure your Internet Connection");?></li>
			<li><?echo i18n("Step 5").": ".i18n("Set your wireless security");?></li>
			<li><?echo i18n("Step 6").": ".i18n("Save Settings and Connect");?></li>			
		</ul>
	</div>
	<? wiz_buttons();?>	
</div>
...
<!-- Start of Stage Advance DNS -->
<div id="stage_adv_dns" class="blackbox" style="display:none;">
	<h2><?echo i18n("Step 3").": ".i18n("Set advance DNS services");?></h2>
	<p>
		<?echo i18n("Advanced Domain Name System (DNS) services enhances your Internet Performance by getting you the information and web pages you and looking for faster and more reliably. In addition, it improves your overall Internet experience by correcting many common typo mistakes automatically, taking you where you intended to go and saving you valuable time.");?>
	</p>
	<div class="gap"></div>
	<div class="textinput">
		<span class="name"><?echo i18n("Enable Advanced DNS Services");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input id="en_adv_dns" type="checkbox" />
		</span>
	</div>
	<? wiz_buttons();?>
</div>
<!-- End of Stage Advance DNS -->
<!-- Start of Stage Wan Detect -->
<div id="stage_wan_detect" style="display:none;">
	<div id="wan_detect" style="display:none;">
		<div class="blackbox"> 
			<h2><?echo i18n("Step 4").": ".i18n("Configure your Internet Connection");?></h2>
			<div><p class="strong">
				<?echo i18n("Router is detecting your Internet connection type, please wait");?>...
			</p></div>
			<div align="center">
	...
	<div id="cable_fail" style="display:none;">
		<div class="blackbox"> 
			<h2><?echo i18n("Step 4").": ".i18n("Configure your Internet Connection");?></h2>
			<div><p class="strong">
				<?echo i18n("Please plug one end of the included Ethernet cable that came with your router into the port labeled INTERNET on the back of the router. Plug the other end of this cable into Ethernet port on your modem.");?>
			</p></div>
			<div align="center">
				<img src="/pic/cable_connection.jpg" width="500" height="350">
			</div>
			<div class="gap"></div>
			<div class="centerline">
	...
	<div id="wantype_unkown" style="display:none;">
		<div class="blackbox"> 
			<h2><?echo i18n("Step 4").": ".i18n("Configure your Internet Connection");?></h2>
			<div><p class="strong">
