...
Page.prototype =
{
	...
	PreSubmit: function()
	{
		...
		var en_24G = XG(this.phyinf+"/active");
		var en_5G	= XG(this.phyinf2+"/active");
		if(OBJ("en_wps").checked)
		{
			if((en_24G == 1 && !this.Is_SecuritySupportedByWps(this.wifip)) || 
				(this.dual_band && en_5G == 1 && !this.Is_SecuritySupportedByWps(this.wifip2)))
		  {
