...
{	
	...
	OnChangeChannel: function(str_Aband)
	{
		if (!OBJ("auto_ch"+str_Aband).checked && /n/.test(OBJ("wlan_mode"+str_Aband).value))
		{
			...
			if( has120==false || (OBJ("channel"+str_Aband).value=="140"|OBJ("channel"+str_Aband).value=="165" |  OBJ("channel"+str_Aband).value=="12"|OBJ("channel"+str_Aband).value=="13"))
			{
