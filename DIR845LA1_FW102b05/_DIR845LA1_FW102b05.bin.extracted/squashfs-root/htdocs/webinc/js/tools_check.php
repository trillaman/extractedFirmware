...
Page.prototype =
{
	...
	OnClick_Ping: function()
	{
		...
		else if (OBJ("dst").value==="0.0.0.0")
		{
			BODY.ShowAlert("<?echo i18n("Please enter a valid host name or IP address for ping.");?>");
			OBJ("dst").focus();
			this.ResetPing();
			return false;
		}
	...
	OnClick_Ping_ipv6: function()
	{
		...
		ajaxObj.setHeader("Content-Type", "application/x-www-form-urlencoded");
		ajaxObj.sendRequest("diagnostic.php", "act=ping6&dst="+OBJ("dst_ipv6").value);
	},
